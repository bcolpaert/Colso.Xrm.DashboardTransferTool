...
namespace Colso.DashboardTransferTool
{
    [Export(typeof(IXrmToolBoxPlugin)),
     ...
     ExportMetadata("Name", "Dashboard Transfer Tool"),
     ExportMetadata("Description", "Helps you to transfer dashboards across organizations")]
    public class Plugin : PluginBase
    {
        public override IXrmToolBoxPluginControl GetControl()
        {
            return new DashboardTransferTool();
        }
    }
}